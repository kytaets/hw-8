...
const ProductCategoryException_1 = require("../exceptions/ProductCategoryException");
let ProductsController = class ProductsController {
    ...
    async create(body) {
        if (!body.category)
            throw new ProductCategoryException_1.ProductCategoryException();
...
exports.ProductsController = ProductsController = __decorate([
    ...
    __metadata("design:paramtypes", [productsService_1.ProductsServise])
], ProductsController);
